    ...
    <div class="relative pt-6 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-28">
        ...
        <nav class="relative flex items-center justify-between sm:h-10 md:justify-center">
          <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
            <div class="flex items-center justify-between w-full md:w-auto">
              <a href="#">
                <img
                  class="h-12 w-auto sm:h-12 rounded-full"
                  src="../assets/images/jack-dorsey-startsmall.jpg"
                  alt
                />
              </a>
            </div>
          ...
          <div class="md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0">
            <span class="inline-flex rounded-md shadow">
              <a
                href="https://twitter.com/intent/tweet?text=Check%20out%20@jack%20's%20new%20fund%20for%20covid19%20relief,%20girl's%20health%20and%20education,%20and%20ubi%20https://startsmall.llc&hashtags=startsmall,covid19,ubi,girlshealth,girlseducation"
                target="_blank"
                class="inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-white twitter focus:outline-none focus:shadow-outline-twitter-blue transition duration-150 ease-in-out"
              >
                Share
                <span class="sr-only">Twitter</span>
                <svg class="h-6 w-6 ml-2" fill="currentColor" viewBox="0 0 24 24">
                  <path
      ...
      <div class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
        <div class="text-center">
          ...
          >
            #start
            <span class="text-blue-600">small</span>
          </h2>
          <p
