                ...
                >
                    ...
                    >
                        ...
                        >
                            <a href="#">
                                <img
                                    class="w-auto h-12 rounded-full sm:h-12"
                    ...
                    >
                        <span class="inline-flex rounded-md shadow">
                            <a
                                ...
                                target="_blank"
                                class="inline-flex items-center px-4 py-2 text-base font-medium leading-6 text-white transition duration-150 ease-in-out border border-transparent rounded-md twitter focus:outline-none focus:shadow-outline-twitter-blue"
                            >
                                Share
